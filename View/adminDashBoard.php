...
<head>
    ...
    <title>FTTC — Dashboard de Reportes</title>
    <meta name="description" content="Dashboard administrativo de reportes de la Fundación Teatro Teresa Carreño">
...
<body>
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="/crud_fetch/View/indexTrabajador.html" class="sidebar-link">Trabajadores Sede
                                    PB</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="/crud_fetch/View/indexTrabajadorSotano.html" class="sidebar-link">Trabajadores
                                    Sede Sotano</a>
                            </li>
                            <li class="sidebar-item">
        ...
        <div class="main">
            ...
            <div class="container-fluid text-center">
                <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                    ...
                    <label class="btn btn-outline-dark fw-bold" for="btncheck1"><i
                            class="fa-solid fa-chart-column pe-2"></i>Graficos Estadisticos</label>
                </div>
                <hr>
                <h3 class="fw-bold display-6">Métricas Diarias</h3>
                <div class="row mb-4">
                    <div class="col-lg-3 col-md-6 animate-in">
                        <div class="card metric-card accent-rose mb-3">
                            <div class="card-header"><i class="fa-solid fa-hand-holding-heart pe-2"></i>Total Pacientes
                                Cortesia</div>
                            <div class="card-body" id="cortesia">
                                <h5 class="card-title">XX.XXX</h5>
                                <p class="card-text">Total de pacientes por cortesia atendidos.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 animate-in">
                        <div class="card metric-card accent-blue mb-3">
                            <div class="card-header"><i class="fa-solid fa-people-group pe-2"></i>Total Parientes</div>
                            <div class="card-body" id="parientes">
                                <h5 class="card-title">XX.XXX</h5>
                                <p class="card-text">Total de Parientes atendidos</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 animate-in">
                        <div class="card metric-card accent-emerald mb-3">
                            <div class="card-header"><i class="fa-solid fa-hospital-user pe-2"></i>Pacientes Hoy</div>
                            <div class="card-body" id="reporte">
                                <h5 class="card-title">XXX</h5>
                                <p class="card-text">Número de pacientes atendidos en el día.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 animate-in">
                        <div class="card metric-card accent-teal mb-3">
                            <div class="card-header"><i class="fa-solid fa-briefcase pe-2"></i>Total Trabajadores</div>
                            <div class="card-body" id="trabajadores">
                                <h5 class="card-title">XX</h5>
                                <p class="card-text">Total de Trabajadores atendidos.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-12 text-start">
                        <h4 class="fw-bold text-black"><i class="fa-solid fa-filter pe-2"></i>Filtros Generales</h4>
                        <div class="row">
                            <form action="adminDashBoard.php" method="GET" class="row">
                                <div class="col-md-4">
                                    <label for="fechaInicio" class="form-label">Fecha Inicio:</label>
                                    <input type="date" class="form-control" id="fechaInicio" name="fechaInicio"
                                        value="<?php echo htmlspecialchars($_GET['fechaInicio'] ?? date('Y-m-01')); ?>">
                                </div>
                                <div class="col-md-4">
                                    <label for="fechaFin" class="form-label">Fecha Fin:</label>
                                    <input type="date" class="form-control" id="fechaFin" name="fechaFin"
                                        value="<?php echo htmlspecialchars($_GET['fechaFin'] ?? date('Y-m-d')); ?>">
                                </div>
                                <div class="col-md-4 d-flex align-items-end">
                                    <button class="btn btn-dark w-100" type="submit" id="boton_filtro"><i
                                            class="fa-solid fa-search pe-2"></i>Aplicar Filtros</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <section id="estadisticasTotales" style="display:none">
                    <h2 class="fw-bold display-6">Estadísticas Totales</h2>
                    <div class="row">
                        <div class="col-md-6 mb-4 animate-in">
                            <div class="card">
                                <div class="card-header fw-bold"><i class="fa-solid fa-stethoscope pe-2"></i>Pacientes
                                    por Especialidades</div>
                                <div class="card-body" id="reporte1-container">
                                    <canvas id="myChart"></canvas>
                                    <button onclick="exportChartToExcel('myChart', 'Grafico_Especialidades')"
                                        class="btn btn-info mt-3"><i
                                            class="fa-solid fa-download pe-2"></i>Exportar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 animate-in">
                            <div class="card">
                                <div class="card-header fw-bold"><i class="fa-solid fa-user-doctor pe-2"></i>Pacientes
                                    por Doctores</div>
                                <div class="card-body" id="reporte2-container">
                                    <canvas id="myChart2"></canvas>
                                    <button onclick="exportChartToExcel('myChart2', 'Grafico_Doctores')"
                                        class="btn btn-info mt-3"><i
                                            class="fa-solid fa-download pe-2"></i>Exportar</button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-4 animate-in">
                            <div class="card">
                                <div class="card-header fw-bold"><i class="fa-solid fa-venus-mars pe-2"></i>Pacientes
                                    por Género</div>
                                <div class="card-body" id="reporte3-container">
                                    <canvas id="myChart3"></canvas>
                                    <button onclick="exportChartToExcel('myChart3', 'Grafico_Pacientes_Por_Genero')"
                                        class="btn btn-info mt-3"><i
                                            class="fa-solid fa-download pe-2"></i>Exportar</button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-4 animate-in">
                            <div class="card">
                                <div class="card-header fw-bold"><i class="fa-solid fa-cake-candles pe-2"></i>Pacientes
                                    por Edad</div>
                                <div class="card-body" id="reporte4-container">
                                    <canvas id="myChart4"></canvas>
                                    <button onclick="exportChartToExcel('myChart4', 'Grafico_Pacientes_Por_Edad')"
                                        class="btn btn-info mt-3"><i
                                            class="fa-solid fa-download pe-2"></i>Exportar</button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-4 animate-in">
                            <div class="card">
                                <div class="card-header fw-bold"><i
                                        class="fa-solid fa-hand-holding-heart pe-2"></i>Cortesía por Mes</div>
                                <div class="card-body" id="reporte7-container">
                                    <canvas id="myChart7"></canvas>
                                    <button onclick="exportChartToExcel('myChart7', 'Grafico_Pacientes_Por_Cortesia')"
                                        class="btn btn-info mt-3"><i
                                            class="fa-solid fa-download pe-2"></i>Exportar</button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-4 animate-in">
                            <div class="card">
                                <div class="card-header fw-bold"><i class="fa-solid fa-people-group pe-2"></i>Parientes
                                    por Mes</div>
                                <div class="card-body" id="reporte6-container">
                                    <canvas id="myChart6"></canvas>
                                    <button onclick="exportChartToExcel('myChart6', 'Grafico_Total_Parientes_Por_Mes')"
                                        class="btn btn-info mt-3"><i
                                            class="fa-solid fa-download pe-2"></i>Exportar</button>
                                </div>
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="card">
                                <div class="card-header fw-bold"><i class="fa-solid fa-briefcase pe-2"></i>Trabajadores
                                    por Mes</div>
                                <div class="card-body" id="reporte5-container">
                                    <canvas id="myChart5"></canvas>
                                    <button
                                        onclick="exportChartToExcel('myChart5', 'Grafico_Total_Trabajadores_Por_Mes')"
                                        class="btn btn-info mt-3"><i
                                            class="fa-solid fa-download pe-2"></i>Exportar</button>
                                </div>
                            </div>
                        ...
                        <hr>
                        <h3 class="fw-bold display-6">Métricas por Fecha</h3>
                        <div class="row mb-4">
                            <div class="col-lg-3 col-md-6 animate-in">
                                <div class="card metric-card accent-rose mb-3">
                                    <div class="card-header"><i class="fa-solid fa-hand-holding-heart pe-2"></i>Total
                                        Pacientes Cortesia</div>
                                    <div class="card-body" id="cortesiaFiltrado">
                                        <h5 class="card-title">XX.XXX</h5>
                                        <p class="card-text">Pacientes por cortesia atendidos.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 animate-in">
                                <div class="card metric-card accent-blue mb-3">
                                    <div class="card-header"><i class="fa-solid fa-people-group pe-2"></i>Total
                                        Parientes</div>
                                    <div class="card-body" id="parientesFiltrado">
                                        <h5 class="card-title">XX.XXX</h5>
                                        <p class="card-text">Parientes atendidos</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 animate-in">
                                <div class="card metric-card accent-emerald mb-3">
                                    <div class="card-header"><i class="fa-solid fa-hospital-user pe-2"></i>Pacientes
                                    </div>
                                    <div class="card-body" id="pacientesFiltrado">
                                        <h5 class="card-title">XXX</h5>
                                        <p class="card-text">Total Pacientes atendidos</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 animate-in">
                                <div class="card metric-card accent-teal mb-3">
                                    <div class="card-header"><i class="fa-solid fa-briefcase pe-2"></i>Total
                                        Trabajadores</div>
                                    <div class="card-body" id="trabajadoresFiltrado">
                                        <h5 class="card-title">XX</h5>
                                        <p class="card-text">Trabajadores atendidos.</p>
                                    </div>
                                </div>
                            </div>
                </section>
                ...
                <section id="datosFiltradoPorFechas">
                    ...
                    <div class="col-md-12 mb-4 animate-in">
                        <div class="card">
                            <div class="card-header fw-bold"><i class="fa-solid fa-chart-pie pe-2"></i>Clasificación de
                                Pacientes por Edad</div>
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    <button onclick="exportTableToExcel('ageClassificationTableBody', 'Reporte_Edad')"
                                        class="btn btn-success mt-3">Exportar Tabla a Excel</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-4 animate-in">
                        <div class="card">
                            <div class="card-header fw-bold"><i class="fa-solid fa-disease pe-2"></i>Pacientes atendidos
                                por Patologías</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover">
                                ...
                                <div class="card-body">
                                    <button onclick="exportTableToExcel('patologiaTableBody', 'Reporte_Patologias')"
                                        class="btn btn-dark mt-3">Exportar Tabla a Excel</button>
                                </div>
                    ...
                    <div class="col-md-12 mb-4 animate-in">
                        <div class="card">
                            <div class="card-header fw-bold"><i class="fa-solid fa-building pe-2"></i>Trabajadores
                                atendidos por Coordinación</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover">
                                        <thead>
                                ...
                                <div class="card-body">
                                    <button
                                        onclick="exportTableToExcel('coordinacionTableBody', 'Reporte_Coordinacion')"
                                        class="btn btn-warning mt-3">Exportar Tabla a Excel</button>
                                </div>
                    ...
                    <div class="col-md-12 mb-4 animate-in">
                        <div class="card">
                            <div class="card-header fw-bold"><i class="fa-solid fa-sitemap pe-2"></i>Parientes atendidos
                                por Coordinación</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover">
                                        <thead>
                                ...
                                <div class="card-body">
                                    <button
                                        onclick="exportTableToExcel('coordinacionParienteTableBody', 'Reporte_Coordinacion')"
                                        class="btn btn-primary mt-3">Exportar Tabla a Excel</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-4 animate-in">
                        <div class="card">
                            <div class="card-header fw-bold"><i class="fa-solid fa-heart-pulse pe-2"></i>Pacientes por
                                Cortesía</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover">
                                ...
                                <div class="card-body">
                                    <button
                                        onclick="exportTableToExcel('institucionCortesiaTableBody', 'Reporte_Cortesia')"
                                        class="btn btn-danger   mt-3">Exportar Tabla a Excel</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script defer>
        ...
        Chart.defaults.plugins.title.font = { size: 14, weight: '600', family: 'Inter' };
        Chart.defaults.scale.grid = { color: 'rgba(148, 163, 184, 0.08)' };
        Chart.defaults.scale.ticks = { color: '#94a3b8' };

        // Dark theme chart color palette
        const darkPalette = ['#3b82f6', '#06b6d4', '#8b5cf6', '#10b981', '#f59e0b', '#f43f5e', '#60a5fa', '#22d399', '#a78bfa', '#34d399', '#fbbf24', '#fb7185'];
        ...
        let myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderWidth: 0,
                    borderRadius: 6,
                    hoverBackgroundColor: darkPalette.map(c => c + 'cc')
                }]
            },
            options: {
                plugins: {
        ...
        var myChart3 = new Chart(ctx3, {
            ...
            options: {
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Personas atendidas según su Género',
                        color: '#f1f5f9',
                    }
                },
                scales: {
        ...
        var myChart4 = new Chart(ctx4, { // Inicializa el gráfico sin datos inicialmente
            ...
            options: {
                plugins: {
                    title: {
                        display: true,
                        text: 'Total de pacientes atendidos por rango de edad',
                        color: '#f1f5f9',
                        position: 'top'
                    },
                    legend: {
