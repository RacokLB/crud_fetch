                            ...
                            <form id="formEditTrabajador">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="editNumeroContacto" name="numero_contacto">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="editCargo" name="cargo">
                                            <?php foreach ($cargos as $cargo) { ?>
                                                <option value="<?php echo $cargo['codigo']; ?>"><?php echo htmlspecialchars($cargo['nombre_cargos']); ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="editCoordinacion" name="coordinacion">
                                            <?php foreach ($coordinaciones as $c) { ?>
                                                <option value="<?php echo $c['codigo_coordinacion']; ?>"><?php echo htmlspecialchars($c['nombre_coordinacion']); ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select name="instruccion" id="editInstruccion" class="form-select">
                                            ...
                                            <?php while ($row = $instruccion->fetch()) { ?>
                                                <option value="<?php echo $row['ID'] ?>"><?php echo $row['grado_instruccion'] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <label for="editCamisa" class="form-label">Talla Camisa:</label>
                                        <input type="text" class="form-control" id="editCamisa" name="talla_camisa">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="editPantalon" class="form-label">Talla Pantalon</label>
                                        <input type="text" class="form-control" id="editPantalon" name="talla_pantalon">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="editZapatos" class="form-label">Talla Zapatos</label>
                                        <input type="text" class="form-control" id="editZapatos" name="talla_zapatos">
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response && typeof response === 'object' && !Array.isArray(response) && response.id) {
                                ...
                                $('#editNumeroContacto').val(trabajador.telefonoMovil); // Corrected to telefonoMovil
                                ...
                                $('#editTelefonoFijo').val(trabajador.telefonoFijo);
                                $('#editEmail').val(trabajador.email);
                                $('#editEstatura').val(trabajador.estatura);
                                $('#editPeso').val(trabajador.peso);
                                $('#editNumHijos').val(trabajador.numeroHijos);
                                $('#editTipoSangre').val(trabajador.tipoSangre);
                                ...
                                $('#editTallaCamisa').val(trabajador.tallaCamisa);
                                $('#editTallaZapatos').val(trabajador.tallaZapatos);
                                $('#editTallaPantalon').val(trabajador.tallaPantalon);
                                ...
                                $('#editCargo').val(trabajador.cargo); // Assuming 'cargo' now holds 'cod_cargo_val'
                                $('#editCoordinacion').val(trabajador.coordinacion); // Assuming 'coordinacion' now holds 'cod_coordinacion_val'

                                $('#editUbicacion').val(trabajador.ubicacion); // 'ubicacion' is the name of the select, assume API returns 'codigo_sede'
                                $('#editInstruccion').val(trabajador.gradoAcademico); // 'instruccion' is the name of the select, assume API returns 'id'
