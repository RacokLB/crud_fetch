                    ...
                    <div class="row text-muted">
                        ...
                        <div class="col-6 text-end">
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a href="#" class="text-muted">FTTC</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            $('#tabla').DataTable({
                ...
                ajax: {
                    url: 'http://localhost/crud_fetch/index.php/?api=parientes', // Your API endpoint
            ...
            $('#guardarCambiosPariente').on('click', function () {
                ...
                $.ajax({
                    url: 'http://localhost/crud_fetch/index.php/?api=actualizarPariente&id=' + ID, // Asume que tu API maneja PUT por ID
