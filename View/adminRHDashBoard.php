...
<body>
    <div class="wrapper">
        ...
        <div class="container mt-5">
            <h2 class="display-5 mb-4 text-center text-white" style="color:antiquewhite">Dashboard de Trabajadores</h2>

            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card bg-dark text-white">
                        <div class="card-body">
                            <h5 class="card-title">Total de Trabajadores <i class="fa-solid fa-users-between-lines"></i></h5>
                            <p class="card-text display-4" id="totalTrabajadores">Cargando... <i class="fa-solid fa-users-between-lines"></i></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <h5 class="card-title">Trabajadores de Vacaciones <i class="fa-solid fa-person-drowning"></i></h5>
                            <p class="card-text display-4" id="trabajadoresVacaciones">Cargando... <i class="fa-solid fa-person-drowning"></i></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card bg-warning text-dark">
                        <div class="card-body">
                            <h5 class="card-title">Trabajadores Jubilables <i class="fa-solid fa-person-cane"></i></h5>
                            <p class="card-text display-4" id="trabajadoresJubilarse">Cargando... <i class="fa-solid fa-person-cane"></i></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card bg-primary">
                        ...
                        <div class="card-body">
                            <p class="card-text display-4" id="trabajadoresDiscapacidad">Cargando... <i class="fa-brands fa-accessible-icon"></i></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 mb-4">
                    <div class="card">
                        <div class="card-header bg-dark text-white fw-bold fs-6">Ultimas personas contratados <i class="fa-solid fa-users"></i></div>
                        <div class="card-body">
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Apellido</th>
                                    <th>Cédula</th>
                                    <th>Fecha Inicio Vacaciones</th> <th>Fecha Reintegro</th> <th>Tiempo Disfrutado</th> </tr>
    ...
    <div class="modal fade" id="discapacidadModal" tabindex="-1" aria-labelledby="discapacidadModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
