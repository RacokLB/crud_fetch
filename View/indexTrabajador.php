...
/*
  ...
  if(!isset($_SESSION['rol'])){//we validate the session exist and case him not exist , get out to login.php
    ...
    if($_SESSION['rol'] != 1){//we validate the session ['rol'] is = 1 and case be difference get out to login.php
      header(header:"location: login.php");
    }
  }
...
<html>
  ...
  <?php
    ...
    $patologia = $pdo->prepare(query: "SELECT id, patologias FROM patologias ORDER BY id DESC");
    $patologia->execute();

    $consultas = $pdo->prepare(query: "SELECT id, especialidades FROM especialidades ORDER BY id DESC");
    $consultas->execute();

    $consultaInterna = $pdo->prepare(query: "SELECT id, especialidades FROM especialidades WHERE id = 1 LIMIT 1");
    $consultaInterna->execute();
  ?>
  <body>
    <div class="wrapper">
      ...
      <div class="main">
          ...
          <main class="col-12 px-3 ">
            <div class="container-fluid">
                <div class="mb-3">
                    <h1 class="fw-bold text-center text-white">Modulo Trabajadores</h1>
                </div>
                <div class="row shadow-lg">
                        ...
                        <div class="card flex-fill border-0 illustration">
                            <div class="card-body p-0 d-flex flex-fill">
                                <div class="row g-0 w-100 ">
                                    <div class="col-6 ">
                                        <div class="p-3 m-1" style="color: white;">
                                            <h4>¡Bienvenido!,<br><?php
                                                              echo "C.I-".$_SESSION["usuario"]."/"."Administrador";
                                                              ?></h4>
                                            <p class="mb-0">Vista Administrador/Servicio Medico</p>
                                        </div>
                                    </div>
                  ...
                  <div class="col-12 col-md-6 d-flex">
                      <div class="card flex-fill border-0">
                          <div class="card-body py-4 text-white fs-bold" style="background-color: black;">
                ...
                <!--CAMPO TITULO-->
                              <div class="card border-3">
                                <div class="card-header shadow-lg " id="card">
                                  <h3 class="card-title text-center text-dark fw-bold">Registro de Trabajadores</h3>
                                </div>
                    ...
                    <!---- Campo Opciones --->
                                    <div class="container-sm">
                                      <h4 class=" fw-bold">Motivo de la Consulta</h4> 
                                        <div class="form-check" id="campo_medicina1">
                                          <input type="radio" class="form-check-input fs-4 bg-dark" value="1" id="tipo_interna" name="tipo_consulta">
                                          <label for="tipo_interna" class="fs-5">Medicina Interna</label>
                                        </div>
                                        <div class="form-check" id="campo_especialidad">
                                          <input type="radio" class="form-check-input fs-4 bg-dark" value="2" id="tipo_especialista" name="tipo_consulta">
                        ...
                        <!--CAMPO UBICACION DEL SERVICIO MEDICO-->
                                    <div class="container" id="main_container" style="display: none;">
                                      <h5 class="fw-bold">Sede del Servicio medico</h5>
                                        <div class="form-check" id="campo_planta">
                                          <input type="radio" class="form-check-input fs-4 bg-dark" value="PB" id="planta" name="sede">
                                          <label for="planta" class="fs-5">Planta Baja</label>
                                        </div>
                                        <div class="form-check" id="campo_sotano">
                                          <input type="radio" class="form-check-input fs-4 bg-dark" value="sotano" id="sotano" name="sede">
                        ...
                        <!---Campo Sexo--->
                                        <div class="d-sm-inline-flex text-center">
                                          <div class="p-2" id="masculinoTrabajador">
                                            <input type="radio" class="form-check-input fs-5 bg-dark focus-ring focus-ring-info" value="M" id="masculino" name="sexo">
                                            <label for="masculino" class="fs-5">Masculino</label>
                                          </div>
                                          <div class="p-2" id="femeninoTrabajador">
                                            <input type="radio" class="form-check-input fs-5 bg-dark focus-ring focus-ring-info" value="F" id="femenino" name="sexo">
                        ...
                        <!--- Campo Medicina General--->
                                      <div class="container-sm" id="campo_medicina">
                                          <div class="mb-3">
                                          <h5 class="text-center fw-bold">Medicina Interna</h5>
                                            <div class="input-group">
                                              ...
                                              <select class="form-select" name="medicina_interna" id="medicina_interna">
                                                <option value=""></option>
                                                <?php while($row = $consultaInterna->fetch(mode: PDO::FETCH_ASSOC)){?>
                        ...
                        <!--- Campo Especialista-->
                                      ...
                                      <h5 class="fw-bold text-center">Especialidad</h5>
                                        <div class="mb-3">
                                          <div class="input-group">
                                            <span class="input-group-text">Especialidad</span>
                                            <select class="form-select" id="especialidades" name="especialidad" data-placeholder="Hazme Click">
                                              <option value=""></option>
                                              <?php while($row = $consultas->fetch(mode: PDO::FETCH_ASSOC)){?>
                                                <option value="<?php echo $row['id'];?>"><?php echo $row['especialidades'];?></option>
                                                <?php } ?>
                                            </select>
                                          </div>
                        ...
                        <!--- Campo Especialista-->
                                        <div class="mb-3">
                                          <div class="input-group">
                                            ...
                                            <select class="form-select" id="especialistas" name="especialista" data-placeholder="Hazme Click">
                                              <option value=""></option>
                                            </select>
                                          </div>
                                        </div>
                        ...
                        <!--Campo Patologia-->
                                        <div class="mb-3">
                                        <h5 class="fw-bold text-center">Sintomas</h5>
                                          <div class="input-group">
                                            ...
                                            <select class="form-select" name="patologia" id="patologia" data-placeholder="Hazme Click">
                                              <option></option>
                                              <?php while($row = $patologia->fetch(mode: PDO::FETCH_ASSOC)){?>
                        ...
                        <!--- Campo Botton Registrar --->
                                        <div class="mb-3 text-center">                  
                                          <input type="button" name="registrar" id="registrar" value="Registrar" class="btn btn-outline-primary focus-ring focus-ring-success btn-lg">  
                                        </div>
                                    </div>
                                  </form>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
          <div class="modal-content">
            <div class="modal-header border-4 border-bottom bg-dark text-white">
              <h1 class="modal-title fs-3">Personas por Cortesia</h1>
  ...
  <!---Campo Motivo de la Consulta--->
                <h5 class="fw-bold text-center">Motivo de la Consulta</h5> 
  ...
  <!--- Datos personales---->
    ...
    <!---Campo Sexo--->
                  <div class="d-sm-inline-flex text-center">
                    <div class="p-2" id="sexo_Masculino">
                      <input type="radio" class="form-check-input fs-5 bg-dark focus-ring focus-ring-info" value="M" id="masculino" name="sexo_cortesia">
                      <label for="masculino" class="fs-5">Masculino</label>
                    </div>
                    <div class="p-2" id="sexo_Femenino">
                      <input type="radio" class="form-check-input fs-5 bg-dark focus-ring focus-ring-info" value="F" id="femenino" name="sexo_cortesia">
                      <label for="femenino" class="fs-5">Femenino</label>
                    </div>
                  </div>
                  <hr>
    ...
    <!--- Campo Afeccion-->
                  <div class="mb-3">
                    <div class="input-group">
                      <span class="input-group-text">Afeccion</span>
                      <input type="text" class="form-control" placeholder="Afeccion del paciente.." id="afeccionCortesia" name="afeccionCortesia"></input>
                    </div>
                  </div>
                </div>
    ...
    <script defer>
        $(document).ready(function(){
          $('#medicinaCortesia').change(function(){
            $('#medicinaCortesia option:selected').each(function(){
              id_interna = $(this).val()
              $.post('Controllers/doctorSearch_controller.php',{id_interna: id_interna},function(data){
          ...
          $('#especialidadCortesia').change(function (){
            $('#especialidadCortesia option:selected').each(function(){
              ...
              $.post('Controllers/doctorSearch_controller.php',{id_especialidad: id_especialidad},function(data){
        ...
        $('input[name="sexo"]').change(function(){
          if($(this).is(':checked')){
            ...
            console.log(sexo)
            if(sexo == 'M'){
              $('#femeninoTrabajador').slideUp(200)
            }if(sexo == 'F'){
              $('#masculinoTrabajador').hide(200) 
            }
          }else{
...
<!---Script del Modulo trabajadores -->
    <script>
      $(document).ready(function(){

        $('#especialidades').change(function(){
          $('#especialidades option:selected').each(function(){
            id_especialidades = $(this).val();
            $.post("../Models/doctorSearch_controller.php", {id_especialidades: id_especialidades}, function(data){
              $('#especialistas').html(data);
            })
          })
        })
        $(document).ready(function (){
