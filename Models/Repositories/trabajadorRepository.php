...
class TrabajadorRepository
{
    ...
    public function guardar(Trabajador $trabajador): ?Trabajador
    {
        ...
        $sqlTrabajador = "INSERT INTO tabla_titular (nacionalidad, cedula, nombres, apellidos, genero, discapacidad, fecha_nacimiento, estado_civil, telefono_fijo, telefono_movil, grado_academico, estatura, peso, num_hijos, email, tipo_sangre, rif, cargo, estatus, fecha_ingreso, coordinacion) 
                    VALUES (:nacionalidad, :cedula, :nombres, :apellidos, :genero, :discapacidad, :fecha_nacimiento, :estado_civil, :telefono_fijo, :telefono_movil, :grado_academico, :estatura, :peso, :num_hijos, :email, :tipo_sangre, :rif, :cargo, :estatus, :fecha_ingreso, :coordinacion)";
        ...
        try {
            ...
            $stmtTrabajador->bindValue(':genero', $trabajador->getGenero());
            ...
            $stmtTrabajador->bindValue(':grado_academico', $trabajador->getGrado_academico());
            ...
            $stmtTrabajador->bindValue(':fecha_ingreso', $trabajador->getFecha_ingreso());
    ...
    public function obtenerTrabajadorPorCedula(int $cedula): ?Trabajador
    { // Added FQCN for Trabajador return type
        $sqlTrabajador = "SELECT
                    ...
                    tabla_titular.rif,
                    tabla_titular.cargo,
                    tabla_cargos.nombre_cargos AS cargo_nombre,
                    tabla_titular.estatus,
                    tabla_titular.fecha_ingreso,
                    tabla_titular.coordinacion,
                    tabla_coordinaciones.nombre_coordinacion AS coordinacion_nombre,
        ...
        try {
            ...
            if ($rowTrabajador) {
                return new Trabajador( // Use FQCN for constructor
                    ...
                    genero: $rowTrabajador['genero'] ?? null,
                    ...
                    grado_academico: $rowTrabajador['grado_academico'] ?? null,
                    ...
                    cargo_id: $rowTrabajador['cargo'] ?? null,
                    cargo: $rowTrabajador['cargo_nombre'] ?? null,
                    estatus: $rowTrabajador['estatus'] ?? null,
                    fecha_ingreso: $rowTrabajador['fecha_ingreso'] ?? null,
                    coordinacion: $rowTrabajador['coordinacion_nombre'] ?? null,
                    coordinacion_id: $rowTrabajador['coordinacion'] ?? null,
    ...
    public function actualizar(Trabajador $trabajador): bool
    {
        ...
        try {
            ...
            $stmtTrabajador->bindValue(':genero', $trabajador->getGenero(), PDO::PARAM_STR);
            ...
            $stmtTrabajador->bindValue(':grado_academico', $trabajador->getGrado_academico(), PDO::PARAM_INT);
            ...
            $stmtTrabajador->bindValue(':cargo_id', $trabajador->getCargo_id(), PDO::PARAM_INT);
            $stmtTrabajador->bindValue(':estatus', $trabajador->getEstatus(), PDO::PARAM_STR);
            $stmtTrabajador->bindValue(':fecha_ingreso', $trabajador->getFecha_ingreso(), PDO::PARAM_STR);
            $stmtTrabajador->bindValue(':coordinacion_id', $trabajador->getCoordinacion_id(), PDO::PARAM_INT);
            ...
            $stmtDireccion->bindValue(':cedula', $trabajador->getCedula(), PDO::PARAM_INT);
            $stmtDireccion->execute();
            ...
            $stmtVestimenta->bindValue(':talla_pantalon', $trabajador->getTalla_pantalon(), PDO::PARAM_INT);
            $stmtVestimenta->bindValue(':cedula', $trabajador->getCedula(), PDO::PARAM_INT);
    ...
    public function obtenerUltimosTrabajadores(): array
    { // El método ahora devuelve un array
