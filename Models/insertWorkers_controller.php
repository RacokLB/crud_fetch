...
if(isset($_POST)){
    ...
    if($consulta == 1){
        ...
        if(!empty($error)){
            ...
            $query = $pdo->prepare(query:"INSERT INTO servicio_medico (sede, cedula, edad, sexo, coordinacion, especialidad, especialista, patologia, afeccion, diagnostico, tratamiento, observaciones) VALUES (:sede, :cedula, :edad, :sexo, :coordinacion, :especialidad, :especialista, :patologia, :afeccion, :diagnostico, :tratamiento, :observaciones)");
