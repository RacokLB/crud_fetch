<?php
    ...
    /**
        ...
        function obtenerTotalPorCoordinaciones(PDO $pdo, $fechaInicio, $fechaFin): array{
            ...
            $query = "SELECT tc.nombre_coordinacion, COUNT(coordinacion) AS total FROM parientes_tratados
            LEFT JOIN tabla_coordinaciones AS tc ON parientes_tratados.coordinacion = tc.codigo_coordinacion
